...
# Builds off of rllib version to allow for providing subclassed TorchPolicy classes
def build_generic_torch_policy(
        name: str,
        *,
        loss_fn: Callable[[
        ...
        generic_torch_policy: Optional[TorchPolicy] = None):
    ...
    def with_updates(**overrides):
        ...
        .. )
        """
        return build_generic_torch_policy(**dict(original_kwargs, **overrides))
